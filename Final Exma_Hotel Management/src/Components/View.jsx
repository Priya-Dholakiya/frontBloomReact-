        ...
        <Card.Body>
          <Row className="gx-5 gy-4">
            <Col xs={12} md={4} className="text-center">
              ...
              <Button className="w-100 fw-bold py-3 book-btn rounded-pill shadow-lg" onClick={handleBookNow} style={{background: 'linear-gradient(135deg, #FFD700, #FFA500)', border: 'none', fontSize: '1.1rem'}}>
                Book Now - Secure Your Stay
              </Button>
            </Col>
            <Col xs={12} md={8}>
